  ...
  return (
    <>
      <div className='mx-[10%] md:mx-[15%] lg:mx-[15%] 2xl:mx-[25%]'>
        <h1 className='text-3xl text-center my-7 text-gray-900 dark:text-gray-300'>ISO 27001 Checklist result</h1>
        <div className='grid w-full'>
          <div className='flex w-full justify-between py-[6px] px-3 border-b-[1px] hover:bg-slate-100/50'>
            <span className='font-medium text-gray-900 dark:text-gray-300'>Company</span>
            <span className='text-gray-900 dark:text-gray-300'>Company Name</span>
          </div>
          <div className='flex w-full justify-between py-[6px] px-3 border-b-[1px] hover:bg-slate-100/50'>
            <span className='font-medium text-gray-900 dark:text-gray-300'>Total Achieved</span>
            <span className='text-gray-900 dark:text-gray-300'>{earnPoints || 0}</span>
          </div>
          <div className='flex w-full justify-between py-[6px] px-3 border-b-[1px] hover:bg-slate-100/50'>
            <span className='font-medium text-gray-900 dark:text-gray-300'>Total should be implemented</span>
            <span className='text-gray-900 dark:text-gray-300'>{totalPoints - earnPoints || 0}</span>
          </div>
          <div className='flex w-full justify-between py-[6px] px-3 border-b-[1px] hover:bg-slate-100/50'>
            <span className='font-medium text-gray-900 dark:text-gray-300'>Total Questions</span>
            <span className='text-gray-900 dark:text-gray-300'>{totalPoints || 0}</span>
          </div>
          <div className='flex flex-col sm:flex-row w-full justify-between py-[6px] px-3 font-medium border-b-[1px] hover:bg-slate-100/50'>
            <span className='text-gray-900 dark:text-gray-300'>ISO 27001</span>
