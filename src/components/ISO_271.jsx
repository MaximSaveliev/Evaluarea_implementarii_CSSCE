...
import Questions from './ISO_271_questions'
...
export default function ISO_271() {
  ...
  if (result.length && result.length >= queue.length) {
    return <Navigate to={'/ISO 27001 result'} replace={true}></Navigate>
  }

  return (
    <>
      <div className='mx-[10%] md:mx-[5%] lg:mx-[15%] 2xl:mx-[25%]'>
        <h1 className='text-center mt-7 font-medium text-lg text-gray-900 dark:text-gray-300'>ISO 27001</h1>
